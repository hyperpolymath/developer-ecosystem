...
git clone https://github.com/hyperpolymath/synapse.git cd synapse
...
toolbox create synapse-dev toolbox enter synapse-dev # Install
...
synapse/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
