...
Synapse follows https://semver.org/[Semantic Versioning]:
...
The CI pipeline will automatically: 1. Build release binaries 2. Create
release artifacts 3. Upload to GitLab releases
...
[arabic]
. Branch from release tag: `+git checkout -b hotfix/v0.1.1 v0.1.0+`
. Apply fix
