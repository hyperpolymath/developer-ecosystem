...
set -euo pipefail
readonly REPO="sigstore/cosign"
export TOOL_NAME="cosign" TOOL_CMD="cosign"
log_info() { echo "[asdf-cosign] $*" >&2; }
fail() { echo "[asdf-cosign] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/cosign-${p}-${a}"; }
