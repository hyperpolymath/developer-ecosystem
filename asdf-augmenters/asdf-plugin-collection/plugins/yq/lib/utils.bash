...
export TOOL_NAME="yq" TOOL_CMD="yq"
log_info() { echo "[asdf-yq] $*" >&2; }
fail() { echo "[asdf-yq] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/yq_${p}_${a}"; }
