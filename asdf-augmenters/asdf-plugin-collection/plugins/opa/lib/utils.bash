...
set -euo pipefail
readonly REPO="open-policy-agent/opa"
export TOOL_NAME="opa" TOOL_CMD="opa"
log_info() { echo "[asdf-opa] $*" >&2; }
fail() { echo "[asdf-opa] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/opa_${p}_${a}"; }
