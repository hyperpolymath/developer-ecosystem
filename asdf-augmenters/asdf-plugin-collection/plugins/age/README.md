...
[![Build](https://github.com/hyperpolymath/asdf-age-plugin/actions/workflows/build.yml/badge.svg)](https://github.com/hyperpolymath/asdf-age-plugin/actions/workflows/build.yml)
[![Lint](https://github.com/hyperpolymath/asdf-age-plugin/actions/workflows/lint.yml/badge.svg)](https://github.com/hyperpolymath/asdf-age-plugin/actions/workflows/lint.yml)
...
[asdf](https://asdf-vm.com) plugin for [age](https://age-encryption.org).
...
```bash
asdf plugin add age https://github.com/hyperpolymath/asdf-age-plugin.git
```
...
asdf local age <version>

# Uninstall a version
asdf uninstall age <version>
```
