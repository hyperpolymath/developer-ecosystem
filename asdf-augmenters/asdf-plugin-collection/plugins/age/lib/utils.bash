...
set -euo pipefail
readonly REPO="FiloSottile/age"
export TOOL_NAME="age" TOOL_CMD="age"
log_info() { echo "[asdf-age] $*" >&2; }
fail() { echo "[asdf-age] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/age-v${v}-${p}-${a}.tar.gz"; }
