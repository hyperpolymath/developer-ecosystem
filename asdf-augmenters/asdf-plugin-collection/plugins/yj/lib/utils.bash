...
set -euo pipefail
readonly REPO="sclevine/yj"
export TOOL_NAME="yj" TOOL_CMD="yj"
log_info() { echo "[asdf-yj] $*" >&2; }
fail() { echo "[asdf-yj] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/yj-${p}-${a}"; }
