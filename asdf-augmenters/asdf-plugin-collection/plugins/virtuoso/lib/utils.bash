...
set -euo pipefail
readonly REPO="openlink/virtuoso-opensource"
export TOOL_NAME="virtuoso" TOOL_CMD="virtuoso"
log_info() { echo "[asdf-virtuoso] $*" >&2; }
fail() { echo "[asdf-virtuoso] ERROR: $*" >&2; exit 1; }
