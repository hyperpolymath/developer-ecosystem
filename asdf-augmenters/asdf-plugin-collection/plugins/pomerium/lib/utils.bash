...
set -euo pipefail
readonly REPO="pomerium/pomerium"
export TOOL_NAME="pomerium" TOOL_CMD="pomerium"
log_info() { echo "[asdf-pomerium] $*" >&2; }
fail() { echo "[asdf-pomerium] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/pomerium-${p}-${a}.tar.gz"; }
