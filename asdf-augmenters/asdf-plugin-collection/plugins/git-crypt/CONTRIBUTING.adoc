...
git clone https://github.com/hyperpolymath/asdf-git-crypt-plugin.git cd
...
toolbox create asdf-git-crypt-plugin-dev toolbox enter
asdf-git-crypt-plugin-dev # Install dependencies manually
...
asdf-git-crypt-plugin/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
