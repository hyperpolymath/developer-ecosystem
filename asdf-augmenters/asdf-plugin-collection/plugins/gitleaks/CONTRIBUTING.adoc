...
git clone https://github.com/hyperpolymath/asdf-gitleaks-plugin.git cd
...
toolbox create asdf-gitleaks-plugin-dev toolbox enter
asdf-gitleaks-plugin-dev # Install dependencies manually
...
asdf-gitleaks-plugin/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
