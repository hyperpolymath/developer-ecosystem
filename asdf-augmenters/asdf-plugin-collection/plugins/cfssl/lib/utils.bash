...
set -euo pipefail
readonly REPO="cloudflare/cfssl"
export TOOL_NAME="cfssl" TOOL_CMD="cfssl"
log_info() { echo "[asdf-cfssl] $*" >&2; }
fail() { echo "[asdf-cfssl] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/cfssl_${v}_${p}_${a}"; }
get_cfssljson_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/cfssljson_${v}_${p}_${a}"; }
