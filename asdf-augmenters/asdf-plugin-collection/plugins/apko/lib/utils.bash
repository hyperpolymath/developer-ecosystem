...
set -euo pipefail
readonly REPO="chainguard-dev/apko"
export TOOL_NAME="apko" TOOL_CMD="apko"
log_info() { echo "[asdf-apko] $*" >&2; }
fail() { echo "[asdf-apko] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/apko_${v}_${p}_${a}.tar.gz"; }
