...
set -euo pipefail
readonly REPO="chainguard-dev/melange"
export TOOL_NAME="melange" TOOL_CMD="melange"
log_info() { echo "[asdf-melange] $*" >&2; }
fail() { echo "[asdf-melange] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/melange_${v}_${p}_${a}.tar.gz"; }
