...
export TOOL_NAME="syft" TOOL_CMD="syft"

log_info() { echo "[asdf-syft] $*" >&2; }
fail() { echo "[asdf-syft] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/syft_${v}_${p}_${a}.tar.gz"; }
