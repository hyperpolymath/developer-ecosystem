...
git clone https://github.com/hyperpolymath/asdf-grype-plugin.git cd
asdf-grype-plugin
...
toolbox create asdf-grype-plugin-dev toolbox enter asdf-grype-plugin-dev
...
asdf-grype-plugin/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
