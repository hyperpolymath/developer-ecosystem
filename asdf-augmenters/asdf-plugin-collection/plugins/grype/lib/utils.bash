...
readonly REPO="anchore/grype"
export TOOL_NAME="grype" TOOL_CMD="grype"

log_info() { echo "[asdf-grype] $*" >&2; }
fail() { echo "[asdf-grype] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/grype_${v}_${p}_${a}.tar.gz"; }
