...
git clone https://github.com/hyperpolymath/asdf-fulcio-plugin.git cd
asdf-fulcio-plugin
...
toolbox create asdf-fulcio-plugin-dev toolbox enter
asdf-fulcio-plugin-dev # Install dependencies manually
...
asdf-fulcio-plugin/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
