...
set -euo pipefail
readonly REPO="sigstore/fulcio"
export TOOL_NAME="fulcio" TOOL_CMD="fulcio"
log_info() { echo "[asdf-fulcio] $*" >&2; }
fail() { echo "[asdf-fulcio] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/fulcio-${p}-${a}"; }
