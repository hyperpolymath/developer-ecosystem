...
set -euo pipefail
readonly REPO="go-acme/lego"
export TOOL_NAME="lego" TOOL_CMD="lego"
log_info() { echo "[asdf-lego] $*" >&2; }
fail() { echo "[asdf-lego] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/lego_v${v}_${p}_${a}.tar.gz"; }
