...
set -euo pipefail
readonly REPO="coredns/coredns"
export TOOL_NAME="coredns" TOOL_CMD="coredns"
log_info() { echo "[asdf-coredns] $*" >&2; }
fail() { echo "[asdf-coredns] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/coredns_${v}_${p}_${a}.tgz"; }
