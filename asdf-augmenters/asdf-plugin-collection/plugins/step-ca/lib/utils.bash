...
set -euo pipefail
readonly REPO="smallstep/certificates"
export TOOL_NAME="step-ca" TOOL_CMD="step-ca"
log_info() { echo "[asdf-step-ca] $*" >&2; }
fail() { echo "[asdf-step-ca] ERROR: $*" >&2; exit 1; }
...
get_download_url() { local v="$1" p a; p="$(get_platform)"; a="$(get_arch)"; echo "https://github.com/${REPO}/releases/download/v${v}/step-ca_${p}_${v}_${a}.tar.gz"; }
