...
set -euo pipefail
readonly REPO="litespeedtech/openlitespeed"
export TOOL_NAME="openlitespeed" TOOL_CMD="openlitespeed"
log_info() { echo "[asdf-openlitespeed] $*" >&2; }
fail() { echo "[asdf-openlitespeed] ERROR: $*" >&2; exit 1; }
