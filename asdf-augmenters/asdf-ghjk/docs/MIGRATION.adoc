...
This guide helps you migrate from standalone ghjk installation to
asdf-ghjk.

=== Table of Contents

* link:#why-migrate[Why Migrate]
...
* link:#common-issues[Common Issues]

=== Why Migrate

Migrating to asdf-ghjk provides:

* *Version Management*: Install and switch between multiple ghjk
versions
* *Project-Specific Versions*: Different projects can use different ghjk
versions
...
[arabic]
. *asdf installed* -
https://asdf-vm.com/guide/getting-started.html[Installation guide]
. *System dependencies*: git, curl, tar
. *Shell properly configured* for asdf
...
. Check the link:FAQ.md[FAQ]
. Open an https://github.com/Hyperpolymath/asdf-ghjk/issues[issue]
...
*Migration complete!* You’re now using asdf-ghjk for better version
management.
