...
[arabic]
. *asdf* - https://asdf-vm.com/guide/getting-started.html[Installation
guide]
...
[arabic]
. *link:EXAMPLES.md[Examples]* - Real-world usage patterns
. *https://github.com/metatypedev/ghjk[ghjk Docs]* - Learn more about
ghjk
. *https://asdf-vm.com[asdf Docs]* - Master asdf version management
...
*Ready to dive deeper?* Check out the link:../README.md[full
documentation]!
