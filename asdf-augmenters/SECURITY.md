...
Replace all {{PLACEHOLDER}} values with your information:
  asdf-augmenters     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  asdf-augmenters             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/asdf-augmenters/security/advisories/new)
...
- This repository (`hyperpolymath/asdf-augmenters`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/asdf-augmenters/security/advisories)
...
When using asdf-augmenters, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/asdf-augmenters/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/asdf-augmenters/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/asdf-augmenters/discussions) |
...
*Thank you for helping keep asdf-augmenters and its users safe.* 🛡️
