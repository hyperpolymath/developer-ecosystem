...
[arabic]
. Navigate to
https://github.com/hyperpolymath/asdf-augmenters/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/asdf-augmenters/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/asdf-augmenters/discussions[GitHub
Discussions]
...
_Thank you for helping keep asdf-augmenters and its users safe._ 🛡️
