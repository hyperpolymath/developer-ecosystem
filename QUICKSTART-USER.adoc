...
// Replace developer-ecosystem, Developer Ecosystem — See README.adoc for details., just run, Developer Ecosystem started successfully. with actuals
= developer-ecosystem — Quick Start for Users
:toc:
:toclevels: 2

== What is developer-ecosystem?

Developer Ecosystem — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./developer-ecosystem-portable
----
...
[source]
----
Developer Ecosystem started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/developer-ecosystem/wiki
