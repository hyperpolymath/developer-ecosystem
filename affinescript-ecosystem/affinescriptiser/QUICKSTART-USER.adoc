= Affinescriptiser — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/affinescriptiser
cd affinescriptiser
...
* https://github.com/hyperpolymath/affinescriptiser/issues — report bugs
