...
* ✅ *Resource Leak Prevention*: Textures, sounds, connections
auto-managed
...
*Indie Game Developers* who want: - Fewer bugs in their game logic -
Compiler-enforced resource management - Type-safe game state machines -
WebAssembly deployment

*Game Jam Participants* who need: - Rapid prototyping with type safety -
No runtime crashes from invalid state - Easy WASM deployment

*Educational Use* for teaching: - Affine types and linear logic -
Type-driven game development - Functional programming concepts
...
*PMPL-1.0-or-later* - Palimpsest Mutual Public License - Covers:
Compiler, tooling, standard library - Permissive with ethical use
requirements - Quantum-safe provenance tracking

==== Game Content & Examples

*AGPL-3.0-or-later* - GNU Affero General Public License - Covers: Game
examples, assets, tutorials - Ensures game content remains open -
...
*GitHub*: https://github.com/hyperpolymath/affinescript *Issues*:
https://github.com/hyperpolymath/affinescript/issues *Discussions*:
https://github.com/hyperpolymath/affinescript/discussions

*Related Projects:* - Gossamer:
https://github.com/hyperpolymath/gossamer (PMPL-1.0-or-later) - Burble:
https://github.com/hyperpolymath/burble (PMPL-1.0-or-later)
...
Jonathan D.A. Jewell and contributors
