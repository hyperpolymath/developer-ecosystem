...
v-graphql a harassment-free experience for everyone, regardless of age,
...
If a maintainer member is involved in an incident:
...
* Appeals are reviewed by a different maintainer member than the
original
...
* Open a
https://github.com/hyperpolymath/v-graphql/discussions[Discussion] (for
general questions)
