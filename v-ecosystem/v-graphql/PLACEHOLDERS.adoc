...
|`+jonathan.jewell@gmail.com+` |Previous/secondary email (for .mailmap)
|`+old@example.com+` |.mailmap

|`+The Open University+` |Author’s organization/affiliation
...
|===
|Placeholder |Description |Example |Files
|`+v-graphql+` |Human-readable project name |`+My Project+`
...
|`+V_GRAPHQL+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+v-graphql+` |Repository name (slug) |`+my-project+` |CONTRIBUTING.md,
...
|`+2026-03-13+` |Current date (ISO) |`+2026-02-14+` |STATE.a2ml,
MAINTAINERS.md

|`+2026-03-13+` |Last updated date |`+2026-02-14+` |TOPOLOGY.md,
THREAT-MODEL.md
|===
...
|`+TODO+` |URL to public PGP key |`+https://keys.openpgp.org/...+`
|SECURITY.md

|`+https://github.com/hyperpolymath+` |Project website
|`+https://example.org+` |SECURITY.md

|`+j.d.a.jewell@open.ac.uk+` |Conduct reports email
|`+conduct@example.org+` |CODE_OF_CONDUCT.md

|`+maintainer+` |Conduct committee name |`+Code of Conduct Committee+`
|CODE_OF_CONDUCT.md

|`+72 hours+` |SLA for initial response |`+48 hours+`
|CODE_OF_CONDUCT.md
|===
...
|===
|Placeholder |Description |Example |Files
|`+PMPL-1.0-or-later+` |License name |`+PMPL-1.0-or-later+`
|ABI-FFI-README.md

|`+V-lang GraphQL implementation and schema generation+` |One-line
project description |`+FFI bridges between languages+` |STATE.a2ml
|===
