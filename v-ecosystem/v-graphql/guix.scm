...
;;
;; Guix package definition for v-graphql
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace v-graphql and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/v-graphql")
  (synopsis "V-lang GraphQL implementation and schema generation")
