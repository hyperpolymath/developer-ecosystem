...
// Replace v-graphql, V Graphql — See README.adoc for details., just run, V Graphql started successfully. with actuals
= v-graphql — Quick Start for Users
:toc:
:toclevels: 2

== What is v-graphql?

V Graphql — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./v-graphql-portable
----
...
[source]
----
V Graphql started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/v-graphql/wiki
