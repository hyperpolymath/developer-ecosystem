...
git clone https://github.com/hyperpolymath/v-graphql.git cd v-graphql
...
toolbox create v-graphql-dev toolbox enter v-graphql-dev # Install
...
v-graphql/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
...
- [`good first issue`](https://github.com/hyperpolymath/v-graphql/labels/good%20first%20issue) — Simple Perimeter 3 tasks
- [`help wanted`](https://github.com/hyperpolymath/v-graphql/labels/help%20wanted) — Community help needed
- [`documentation`](https://github.com/hyperpolymath/v-graphql/labels/documentation) — Docs improvements
- [`perimeter-3`](https://github.com/hyperpolymath/v-graphql/labels/perimeter-3) — Community sandbox scope
