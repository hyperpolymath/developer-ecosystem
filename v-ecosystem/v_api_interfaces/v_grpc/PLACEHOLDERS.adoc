...
All placeholders in this template follow the `+v-grpc+` pattern. After
...
|`+v-grpc+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+v-grpc+` |One-line project description
...
These are *not* standard `+v-grpc+` markers – they are TODO markers that
