...
All placeholders in this template follow the `v-rest` pattern.
...
sed -i 's/v-rest/MY_PROJECT/g' $(grep -rl 'v-rest' .)
...
| `v-rest` | One-line description | `A tool for X` | flake.nix |
| `v-rest` | Uppercase identifier (for Idris2 modules, C macros) | `MY_PROJECT` | ABI-FFI-README.md, src/abi/*.idr, ffi/zig/*.zig |
...
| `v-rest` | One-line project description | `FFI bridges between languages` | STATE.a2ml |
...
These are **not** standard `v-rest` markers -- they are TODO markers
