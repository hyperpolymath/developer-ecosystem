...
|===
|Placeholder |Description |Example |Files
|`+v-rest+` |Human-readable project name |`+My Project+` |SECURITY.md,
CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md,
MAINTAINERS.md, flake.nix, devcontainer.json

|`+V-lang REST API framework with Idris2 ABI proofs and Zig FFI+`
...
|`+v-rest+` |Repository name (slug) |`+my-project+` |CONTRIBUTING.md,
