...
2. The Jonathan Jewell (maintainer) will review the report
...
If a Jonathan Jewell (maintainer) member is involved in an incident:
...
The Jonathan Jewell (maintainer) will follow these guidelines in determining consequences:
...
- Appeals are reviewed by a different Jonathan Jewell (maintainer) member than the original
