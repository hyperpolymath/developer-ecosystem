...
git clone https://github.com/hyperpolymath/v-rest.git cd v-rest
...
toolbox create v-rest-dev toolbox enter v-rest-dev # Install
...
v-rest/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
