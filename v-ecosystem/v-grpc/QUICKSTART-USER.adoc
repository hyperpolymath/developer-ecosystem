...
// Replace v-grpc, V Grpc — See README.adoc for details., just run, V Grpc started successfully. with actuals
= v-grpc — Quick Start for Users
:toc:
:toclevels: 2

== What is v-grpc?

V Grpc — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./v-grpc-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/v-grpc/wiki
