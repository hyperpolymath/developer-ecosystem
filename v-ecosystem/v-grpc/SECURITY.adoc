...
[arabic]
. Navigate to
https://github.com/hyperpolymath/v-grpc/security/advisories/new[Report a
Vulnerability]
...
* This repository (`+hyperpolymath/v-grpc+`) and all its code
...
https://github.com/hyperpolymath/v-grpc/security/advisories[Security
Advisories]
...
When using v-grpc, we recommend:
...
|Purpose |Contact
|*Security issues*
|https://github.com/hyperpolymath/v-grpc/security/advisories/new[Report
via GitHub] or j.d.a.jewell@open.ac.uk

|*General questions*
|https://github.com/hyperpolymath/v-grpc/discussions[GitHub Discussions]
...
_Thank you for helping keep v-grpc and its users safe._ 🛡️
