...
// Replace v-grpc, developer-ecosystem, {{DEPS}} with actuals
= v-grpc — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining v-grpc for
...
* Upstream: https://github.com/hyperpolymath/v-grpc/issues
