...
;;
;; Guix package definition for v-benchmarks
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace v-benchmarks and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/v-benchmarks")
  (synopsis "v-benchmarks")
