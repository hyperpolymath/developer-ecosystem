...
|`+v-benchmarks+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+v-benchmarks+` |One-line project description
...
These are *not* standard `+v-benchmarks+` markers – they are TODO
