...
git clone https://github.com/hyperpolymath/scaffoldia.git cd scaffoldia
...
toolbox create scaffoldia-dev toolbox enter scaffoldia-dev # Install
...
scaffoldia/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
