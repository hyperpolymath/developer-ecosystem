...
sed -i 's/6759885+hyperpolymath@users.noreply.github.com/security@example.com/g' .well-known/security.txt
...
Generic templates use `well-known-ecosystem` syntax:
