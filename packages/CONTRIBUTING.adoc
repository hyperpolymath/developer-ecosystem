...
git clone https://github.com/hyperpolymath/packages.git cd packages
...
toolbox create packages-dev toolbox enter packages-dev # Install
...
packages/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
