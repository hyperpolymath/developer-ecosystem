...
sed -i 's/julianiser/my-project/g' $(grep -rl 'julianiser' .)
...
| `julianiser` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
