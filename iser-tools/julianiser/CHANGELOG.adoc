...
All notable changes to julianiser will be documented in this file.
...
==== Added
- Bespoke Idris2 ABI types: JuliaModule, DataFrameOp, BroadcastPattern, TypeAnnotation
- Zig FFI stubs for Julia code generation and benchmark harness
- CLI scaffold with subcommands (init, validate, generate, build, run, info)
- Manifest parser for julianiser.toml
- Codegen engine stubs for Python/R to Julia translation
...
- Manifest parser (`julianiser.toml`)
