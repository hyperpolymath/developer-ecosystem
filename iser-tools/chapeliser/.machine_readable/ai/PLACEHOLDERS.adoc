...
sed -i 's/chapeliser/my-project/g' $(grep -rl 'chapeliser' .)
...
| `chapeliser` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
