# chapeliser — Project Instructions

## Overview

General-purpose Chapel acceleration framework

**Status:** pre-alpha
**Priority in -iser family:** 2
**Part of:** https://github.com/hyperpolymath/iseriser (-iser ecosystem)

## Architecture

All -iser projects follow the same architecture:
- **Manifest** (`chapeliser.toml`) — user describes WHAT they want
