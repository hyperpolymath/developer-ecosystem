...
sed -i 's/futharkiser/my-project/g' $(grep -rl 'futharkiser' .)
...
| `futharkiser` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
