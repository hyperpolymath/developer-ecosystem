...
All notable changes to anvomidaviser will be documented in this file.
...
==== Added
- Bespoke Idris2 ABI types for ISU scoring: BaseValue, GOE, PCS, TES, ElementCode
- Zig FFI stubs with anvomidaviser-specific scoring symbols
- CLI scaffold with subcommands (init, validate, generate, build, run, info)
- Manifest parser for anvomidaviser.toml
- Codegen engine stubs for ISU notation parsing and Anvomidav program generation
- Full RSR template (17 CI workflows, governance, bot directives)
- Bespoke documentation: README.adoc, ROADMAP.adoc, ../../.github/CONTRIBUTING.md
