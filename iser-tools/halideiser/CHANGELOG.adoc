...
All notable changes to halideiser will be documented in this file.
...
==== Added
- Bespoke Idris2 ABI types: HalideFunc, Schedule, BufferDim, PipelineStage, TargetArch
- Zig FFI stubs for Halide pipeline compilation and schedule execution
- CLI scaffold with subcommands (init, validate, generate, build, run, info)
- Manifest parser for halideiser.toml
- Codegen engine stubs for Halide algorithm and schedule generation
