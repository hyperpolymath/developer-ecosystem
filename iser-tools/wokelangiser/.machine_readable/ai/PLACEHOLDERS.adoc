...
sed -i 's/wokelangiser/my-project/g' $(grep -rl 'wokelangiser' .)
...
| `wokelangiser` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
