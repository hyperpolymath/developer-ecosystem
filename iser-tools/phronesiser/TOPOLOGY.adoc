...
Phronesiser adds provably safe ethical constraints to AI agent
decision-making via Phronesis deontic logic. It compiles agent behaviour
specifications into formally verified constraint sets enforced at
runtime with full audit trails.
...
|`+EthicalConstraint+` |Named constraint with modality, scope, and
formal proposition
