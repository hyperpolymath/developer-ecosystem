...
Rust CLI tool that scans code for array computation patterns (loops,
maps, folds, comprehensions) and rewrites them as optimized BQN array
primitives. Delivers 10-100x speedups on array-heavy workloads without
requiring users to learn BQN explicitly.
