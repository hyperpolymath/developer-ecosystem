...
Staging repository for IDApixiTIK (hacking/network simulator game)
migration to ReScript 13 with zero deprecated APIs. Browser-based game
with combat, companion systems, training scenarios, network simulation,
and Phoenix WebSocket multiplayer infrastructure.
