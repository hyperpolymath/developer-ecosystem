...
sed -i 's/Rescript Tea/my-project/g' $(grep -rl 'Rescript Tea' .)
...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `Rescript Tea` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
...
| `rescript-tea` | Repository name (slug) | `my-project` | CONTRIBUTING.md, SECURITY.md, CODE_OF_CONDUCT.md, cliff.toml |
