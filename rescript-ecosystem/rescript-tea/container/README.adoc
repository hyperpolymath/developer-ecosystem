...
= Rescript Tea Container Templates
:toc: left
:toclevels: 3
:sectnums:
...
All files use `rescript-tea` tokens that are replaced by `just container-init`
...
(service name, port, registry) and substitutes all `rescript-tea`
