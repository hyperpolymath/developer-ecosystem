...
Replace all {{PLACEHOLDER}} values with your information:
  Rescript Tea     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  rescript-tea             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/rescript-tea/security/advisories/new)
...
- This repository (`hyperpolymath/rescript-tea`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/rescript-tea/security/advisories)
...
When using Rescript Tea, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/rescript-tea/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/rescript-tea/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/rescript-tea/discussions) |
...
*Thank you for helping keep Rescript Tea and its users safe.* 🛡️
