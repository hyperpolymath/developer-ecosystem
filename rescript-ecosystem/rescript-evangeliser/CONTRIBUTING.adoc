...
____
*Note:* This project is mid-migration from _ReScript Evangeliser_ to
_Nextgen Languages Evangeliser_ (flagship target: AffineScript). Some
sections below still reference the ReScript-centric dev setup — these
will be updated through Phases 1–3. See `+ROADMAP.adoc+`.
____
...
https://github.com/Hyperpolymath/nextgen-languages-evangeliser/projects[GitHub
Projects]):
