...
image:https://img.shields.io/badge/ReScript-v13-e6484f?style=flat-square[ReScript v13]
...
Issues and pull requests welcome. Please use ReScript v13 syntax and
UK English spelling in documentation. See link:../../.github/CONTRIBUTING.md[../../.github/CONTRIBUTING.md].
