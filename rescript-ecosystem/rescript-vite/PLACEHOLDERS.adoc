...
|`+rescript-vite+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+rescript-vite+` |One-line project description
...
These are *not* standard `+rescript-vite+` markers – they are TODO
