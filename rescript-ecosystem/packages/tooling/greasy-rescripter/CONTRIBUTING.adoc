...
git clone https://github.com/hyperpolymath/greasy-rescripter.git cd
greasy-rescripter
...
toolbox create greasy-rescripter-dev toolbox enter greasy-rescripter-dev
...
greasy-rescripter/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
