...
git clone https://github.com/hyperpolymath/rescript-openapi.git cd
rescript-openapi
...
toolbox create rescript-openapi-dev toolbox enter rescript-openapi-dev #
...
rescript-openapi/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
