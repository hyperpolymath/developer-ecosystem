...
git clone https://github.com/hyperpolymath/rescript-tauri.git cd
rescript-tauri
...
toolbox create rescript-tauri-dev toolbox enter rescript-tauri-dev #
...
rescript-tauri/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
