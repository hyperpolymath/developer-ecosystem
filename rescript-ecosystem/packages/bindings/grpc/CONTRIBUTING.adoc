...
git clone https://github.com/hyperpolymath/rescript-grpc.git cd
rescript-grpc
...
toolbox create rescript-grpc-dev toolbox enter rescript-grpc-dev #
...
rescript-grpc/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
