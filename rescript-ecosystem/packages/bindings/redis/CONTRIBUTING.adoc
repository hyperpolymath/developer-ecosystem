...
git clone https://github.com/hyperpolymath/rescript-redis.git cd
rescript-redis
...
toolbox create rescript-redis-dev toolbox enter rescript-redis-dev #
...
rescript-redis/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
