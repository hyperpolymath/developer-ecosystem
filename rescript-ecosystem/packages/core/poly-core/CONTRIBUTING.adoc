...
git clone https://github.com/hyperpolymath/rescript-poly-core.git cd
rescript-poly-core
...
toolbox create rescript-poly-core-dev toolbox enter
rescript-poly-core-dev # Install dependencies manually
...
rescript-poly-core/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
