...
git clone https://github.com/hyperpolymath/rescript-env.git cd
rescript-env
...
toolbox create rescript-env-dev toolbox enter rescript-env-dev # Install
...
rescript-env/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
