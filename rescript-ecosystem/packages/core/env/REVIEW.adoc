...
MIT OR PMPL-1.0-or-later with Palimpsest philosophical overlay provides flexibility while encouraging consent-based practices.
...
File still contains `env` values:
...
* LICENSE.txt states "MIT OR PMPL-1.0-or-later"
