...
git clone https://github.com/hyperpolymath/rescript-runtime-tools.git cd
...
toolbox create rescript-runtime-tools-dev toolbox enter
rescript-runtime-tools-dev # Install dependencies manually
...
rescript-runtime-tools/ ├── src/ # Source code (Perimeter 1-2) ├── lib/
