...
git clone https://github.com/hyperpolymath/rescript-early-return.git cd
...
toolbox create rescript-early-return-dev toolbox enter
rescript-early-return-dev # Install dependencies manually
...
rescript-early-return/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
