...
;; STATE.scm - Project state tracking for rescript-early-return
;; Media-Type: application/vnd.state+scm

(define-state rescript-early-return
  (metadata
    (version "0.1.0")
    ...
    (repo "hyperpolymath/rescript-early-return"))
