...
;; STATE.scm - Project state tracking for rescript-compiler-source
;; Media-Type: application/vnd.state+scm

(define-state rescript-compiler-source
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "rescript-compiler-source")
    (repo "hyperpolymath/rescript-compiler-source"))

  (project-context
    (name "rescript-compiler-source")
