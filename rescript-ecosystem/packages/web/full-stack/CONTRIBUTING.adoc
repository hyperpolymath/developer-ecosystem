...
git clone https://github.com/hyperpolymath/rescript-full-stack.git cd
rescript-full-stack
...
toolbox create rescript-full-stack-dev toolbox enter
rescript-full-stack-dev # Install dependencies manually
...
rescript-full-stack/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
