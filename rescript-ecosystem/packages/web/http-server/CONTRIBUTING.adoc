...
git clone https://github.com/hyperpolymath/rescript-http-server.git cd
...
toolbox create rescript-http-server-dev toolbox enter
rescript-http-server-dev # Install dependencies manually
...
rescript-http-server/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
