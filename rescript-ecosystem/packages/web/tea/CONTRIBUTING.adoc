...
git clone https://github.com/hyperpolymath/rescript-tea.git cd
rescript-tea
...
toolbox create rescript-tea-dev toolbox enter rescript-tea-dev # Install
...
rescript-tea/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
