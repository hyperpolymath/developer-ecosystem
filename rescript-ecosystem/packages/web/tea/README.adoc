...
image:https://img.shields.io/badge/License-MPL--2.0-indigo.svg[Palimpsest-MPL-1.0,link="https://github.com/hyperpolymath/palimpsest-license"]
...
See link:../../../../.github/CONTRIBUTING.md[CONTRIBUTING] for details on how to contribute.
