...
git clone https://github.com/hyperpolymath/rescript-websocket.git cd
rescript-websocket
...
toolbox create rescript-websocket-dev toolbox enter
rescript-websocket-dev # Install dependencies manually
...
rescript-websocket/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
