...
* WebSocket implementation is placeholder (needs full
...
*Legend* - ✨ New feature - 🐛 Bug fix - 📝 Documentation - 🔧 Tooling -
⚡ Performance - 🔒 Security - 🚨 Breaking change - 🗑️ Deprecated

For more details on any release, see the
https://github.com/yourusername/rescript-wasm-runtime/releases[GitHub
Releases] page.
