...
* Assuming good faith and positive intent
...
This project recognizes that *emotional safety* is as important as
technical correctness. We commit to:

==== Reversibility First

* All actions can be undone or rolled back
* No permanent consequences for experimental contributions
...
* Patient mentorship for newcomers
* No "`stupid questions`"
...
* Safe to propose unconventional ideas
* Safe to disagree respectfully
* Safe to take breaks when needed
* Safe to set boundaries

==== Burnout Prevention

* Respect maintainer capacity
* No expectation of 24/7 availability
* Acknowledge volunteer nature of contributions
...
Emotional Safety section inspired by research on developer well-being
and psychological safety in open source.

=== Contact

* *Code of Conduct Enforcement*: conduct@example.com
