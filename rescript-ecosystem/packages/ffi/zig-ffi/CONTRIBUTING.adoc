...
git clone https://github.com/hyperpolymath/rescript-zig-ffi.git cd
rescript-zig-ffi
...
toolbox create rescript-zig-ffi-dev toolbox enter rescript-zig-ffi-dev #
...
rescript-zig-ffi/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
